export const ETHIOPIAN_CITIES: { name: string; nameAm: string; lat: number; lon: number }[] = [
  ...
  { name: 'Dire Dawa', nameAm: 'ድረስ', lat: 9.5931, lon: 41.8661 },
  { name: 'Mekelle', nameAm: 'ማከል', lat: 13.4967, lon: 39.4734 },
  { name: 'Gondar', nameAm: 'ጋንዳር', lat: 12.6031, lon: 37.4518 },
  ...
  { name: 'Awasa', nameAm: 'አዋሳ', lat: 6.9500, lon: 38.4667 },
];

export const KIREMT_MONTHS = [6, 7, 8, 9];
export const KIREMT_LABEL_AM = 'ኪረምት';
